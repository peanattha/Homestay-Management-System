                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                <a href="{{ route('confirm-pay-admin', $booking->id) }}"
                                    ...
                                    class="btn btn-success">ยืนยันการชำระเงิน</a>
                                <a href="{{ route('cancel-pay-admin', $booking->id) }}"
                                    onclick="return confirm('คุณเเน่ใจที่จะ ยกเลิกการจอง')"
